          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="relative w-32 h-32">
                <ChartWrapper fallback={<div className="w-32 h-32 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse flex items-center justify-center"><span className="text-gray-500 text-xs">Loading...</span></div>}>
                  <Suspense fallback={<div className="w-32 h-32 bg-gray-200 dark:bg-gray-700 rounded-full animate-pulse"></div>}>
